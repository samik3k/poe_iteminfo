...
global ItemTypes := Object() ; super-global
;#################### new code
LoadLangData(Name) {
	global ItemTypes
	Loop, Read, %A_ScriptDir%\data\ru\%Name%.txt
	{
			...
			;MsgBox % "line " . ALine . " from " . Name
			StringSplit, ItemTypes, ALine, =,
			ItemTypes[ItemTypes1] := ItemTypes2
			;MsgBox % "defined " . ItemTypes1 . " as " . ItemTypes2 . " " . ItemTypes[ItemTypes1]
	}
}
LoadLangData("itemTypes")

;MsgBox % "defined " . H_Dagger
;MsgBox % "defined " . ItemTypes.H_Dagger
;MsgBox % "defined " . ItemTypes.H_Unidentified
;#############################################
...
{
		global ItemTypes
		H_Damage := ItemTypes.H_Damage
    IfInString, String, %H_Damage% %DmgType%
    {
				H_Converted_to := ItemTypes.H_Converted_to
				H_taken_as := ItemTypes.H_taken_as
				H_increased := ItemTypes.H_increased
        IfInString, String, %H_Converted_to% or IfInString, String, %H_taken_as%
        {
            return
        }
        IfNotInString, String, %H_increased% 
        {
...
ParseItemType(ItemDataStats, ItemDataNamePlate, ByRef BaseType, ByRef SubType, ByRef GripType)
{
    ...
    GripType = None
		...
		H_One_Handed_Axe := ItemTypes.H_One_Handed_Axe
		H_Two_Handed_Axe := ItemTypes.H_Two_Handed_Axe
		H_One_Handed_Mace := ItemTypes.H_One_Handed_Mace
		H_Two_Handed_Mace := ItemTypes.H_Two_Handed_Mace
		H_Sceptre := ItemTypes.H_Sceptre
		H_Staff := ItemTypes.H_Staff
		H_One_Handed_Sword := ItemTypes.H_One_Handed_Sword
		H_Two_Handed_Sword := ItemTypes.H_Two_Handed_Sword
		H_Dagger := ItemTypes.H_Dagger
		H_Claw := ItemTypes.H_Claw
		H_Bow := ItemTypes.H_Bow
		H_Wand := ItemTypes.H_Wand
		
		H_Belt := ItemTypes.H_Belt
		H_Amulet := ItemTypes.H_Amulet
		H_Ring := ItemTypes.H_Ring
		H_Quiver := ItemTypes.H_Quiver
		H_Flask := ItemTypes.H_Flask
		H_Map := ItemTypes.H_Map
		
		H_Gloves := ItemTypes.H_Gloves
		H_Shields := ItemTypes.H_Shields
		H_Helms := ItemTypes.H_Helms
		H_Boots := ItemTypes.H_Boots
		H_Armors := ItemTypes.H_Armors
    ...
    {
        IfInString, A_LoopField, %H_One_Handed_Axe%
        {
            BaseType = Weapon
            SubType = Axe
            GripType = 1H
        ...
        IfInString, A_LoopField, %H_Two_Handed_Axe%
        {
            BaseType = Weapon
            SubType = Axe
            GripType = 2H
        ...
        IfInString, A_LoopField, %H_One_Handed_Mace%
        {
            BaseType = Weapon
            SubType = Mace
            GripType = 1H
        ...
        IfInString, A_LoopField, %H_Two_Handed_Mace%
        {
            BaseType = Weapon
            SubType = Mace
            GripType = 2H
        ...
        IfInString, A_LoopField, %H_Sceptre%
        {
            BaseType = Weapon
            SubType = Sceptre
            GripType = 1H
        ...
        IfInString, A_LoopField, %H_Staff%
        {
            BaseType = Weapon
            SubType = Staff
            GripType = 2H
        ...
        IfInString, A_LoopField, %H_One_Handed_Sword%
        {
            BaseType = Weapon
            SubType = Sword
            GripType = 1H
        ...
        IfInString, A_LoopField, %H_Two_Handed_Sword%
        {
            BaseType = Weapon
            SubType = Sword
            GripType = 2H
        ...
        IfInString, A_LoopField, %H_Dagger%
        {
            BaseType = Weapon
            SubType = Dagger
            GripType = 1H
    ...
    Loop, Parse, ItemDataNamePlate, `n, `r
    {
        ...
        ; Belts, Amulets, Rings, Quivers, Flasks, Map
        If(RegExMatch(A_LoopField, H_Belt))
        {
            BaseType = Item
            SubType = Belt
            return
        }
        If(RegExMatch(A_LoopField, H_Amulet))
        {
            BaseType = Item
            SubType = Amulet
            return
        }
        If(RegExMatch(A_LoopField, H_Ring))
        {
            BaseType = Item
            SubType = Ring
            return
        }
        IfInString, A_LoopField, %H_Quiver%
        {
            BaseType = Item
            SubType = Quiver
            return
        }
        IfInString, A_LoopField, %H_Flask%
        {
            BaseType = Item
            SubType = Flask
            return
        }
        IfInString, A_LoopField, %H_Map%%A_Space%
        {
            Global matchList
            BaseType = Map      
        ...
        ; Shields
				If(RegExMatch(A_LoopField, H_Shields))
        {
            BaseType = Armour
            SubType = Shield
            return
				...
				; Gloves
        IfInString, A_LoopField, %H_Gloves%
        {
            BaseType = Armour
            SubType = Gloves
            return
        ...
        ; Helms
        If(RegExMatch(A_LoopField, H_Helms))
        {
            BaseType = Armour
            SubType = Helmet
            return
        ...
        ; Boots
				If(RegExMatch(A_LoopField, H_Boots))
        {
            BaseType = Armour
            SubType = Boots
            return
				...
				; Armors
				If(RegExMatch(A_LoopField, H_Armors))
        {
            BaseType = Armour
            SubType = BodyArmour
            return
...
ParseQuality(ItemDataNamePlate)
{
		global ItemTypes
    ItemQuality := 0
		H_Unidentified := ItemTypes.H_Unidentified
		H_Quality := ItemTypes.H_Quality
    Loop, Parse, ItemDataNamePlate, `n, `r
    {
        ...
        IfInString, A_LoopField, %H_Unidentified%
        {
            Break
        }
        IfInString, A_LoopField, %H_Quality%
        {
            ItemQuality := RegExReplace(A_LoopField, %H_Quality% . ": \+(\d+)% .*", "$1")
            Break
        }
    }
    return ItemQuality
...
ParseRequirements(ItemDataChunk, ByRef Level, ByRef Attributes, ByRef Values="")
{
    ...
    DelimLen := StrLen(Delim)
		H_Str := ItemTypes.H_Str
		H_Dex := ItemTypes.H_Dex
		H_Int := ItemTypes.H_Int
		H_Level := ItemTypes.H_Level
    Loop, Parse, ItemDataChunk, `n, `r
    {    
        If StrLen(A_LoopField) = 0
        {
        ...
        IfInString, A_LoopField, %H_Str%
        {
            Attr := Attr . H_Str . Delim
            AttrValues := AttrValues . GetColonValue(A_LoopField) . Delim
        }
        IfInString, A_LoopField, %H_Dex%
        {
            Attr := Attr . H_Dex . Delim
            AttrValues := AttrValues . GetColonValue(A_LoopField) . Delim
        }
        IfInString, A_LoopField, %H_Int%
        {
            Attr := Attr . H_Int . Delim
            AttrValues := AttrValues . GetColonValue(A_LoopField) . Delim
        }
        IfInString, A_LoopField, %H_Level%
        {
...
{    
    Global AffixTotals, ItemTypes
    
		H_Unidentified := ItemTypes.H_Unidentified
    IfInString, ItemDataChunk, %H_Unidentified%
    {
...
{
    Global Globals, Opts, AffixTotals, ItemTypes
    ...
    ; --- PRE-PASS ---
		...
		H_Unidentified := ItemTypes.H_Unidentified
		H_increased_Light_Radius := ItemTypes.H_increased_Light_Radius
		H_increased_Quantity := ItemTypes.H_increased_Quantity
		H_increased_Physical_Damage := ItemTypes.H_increased_Physical_Damage
		H_increased_Accuracy_Rating := ItemTypes.H_increased_Accuracy_Rating
		H_to_Accuracy_Rating := ItemTypes.H_to_Accuracy_Rating
		H_increased_Armour_and_Evasion := ItemTypes.H_increased_Armour_and_Evasion
		H_increased_Armour_and_Energy_Shield := ItemTypes.H_increased_Armour_and_Energy_Shield
		H_increased_Evasion_and_Energy_Shield := ItemTypes.H_increased_Evasion_and_Energy_Shield
		H_increased_Armour := ItemTypes.H_increased_Armour
		H_increased_Evasion_Rating := ItemTypes.H_increased_Evasion_Rating
		H_increased_Energy_Shield := ItemTypes.H_increased_Energy_Shield
		H_increased_Stun_Recovery := ItemTypes.H_increased_Stun_Recovery
		H_increased_Spell_Damage := ItemTypes.H_increased_Spell_Damage
		H_to_maximum_Mana := ItemTypes.H_to_maximum_Mana
		H_Can_have_multiple_Crafted_Mods := ItemTypes.H_Can_have_multiple_Crafted_Mods
    ...
    Loop, Parse, ItemDataChunk, `n, `r
    {
        ...
        IfInString, A_LoopField, %H_increased_Light_Radius%
        {
            HasIncrLightRadius := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Quantity%
        {
            HasIIQ := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Physical_Damage%
        {
            HasIncrPhysDmg := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Accuracy_Rating%
        {
            HasIncrAccuracyRating := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_to_Accuracy_Rating%
        {
            HasToAccuracyRating := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Armour_and_Evasion%
        {
            HasHybridDefences := A_Index
            HasIncrArmourAndEvasion := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Armour_and_Energy_Shield%
        {
            HasHybridDefences := A_Index
            HasIncrArmourAndES := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Evasion_and_Energy_Shield%
        {
            HasHybridDefences := A_Index
            HasIncrEvasionAndES := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Armour%
        {
            HasIncrArmour := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Evasion_Rating%
        {
            HasIncrEvasion := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Energy_Shield%
        {
            HasIncrEnergyShield := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Stun_Recovery%
        {
            HasStunRecovery := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_increased_Spell_Damage%
        {
            HasSpellDamage := A_Index
            Continue
        }
        IfInString, A_LoopField, %H_to_maximum_Mana%
        {
            HasMaxMana := A_Index
            Continue
        }
        IfInString, A_Loopfield, %H_Can_have_multiple_Crafted_Mods%
        {
    ...
    ; methods.
		...
		H_increased_Attack_Speed := ItemTypes.H_increased_Attack_Speed
		H_to_all_Attributes := ItemTypes.H_to_all_Attributes
		H_to_Strength := ItemTypes.H_to_Strength
		H_to_Intelligence := ItemTypes.H_to_Intelligence
		H_to_Dexterity := ItemTypes.H_to_Dexterity
		H_increased_Cast_Speed := ItemTypes.H_increased_Cast_Speed
		H_increased_Critical_Strike_Chance_for_Spells := ItemTypes.H_increased_Critical_Strike_Chance_for_Spells
		
		H_Critical_Strike_Chance := ItemTypes.H_Critical_Strike_Chance
		H_Critical_Strike_Chance_Sub := ".*" . H_Critical_Strike_Chance
		
		H_Critical_Strike_Multiplier := ItemTypes.H_Critical_Strike_Multiplier
		H_increased_Fire_Damage := ItemTypes.H_increased_Fire_Damage
		H_increased_Cold_Damage := ItemTypes.H_increased_Cold_Damage
		H_increased_Lightning_Damage := ItemTypes.H_increased_Lightning_Damage
		H_Block_Chance := ItemTypes.H_Block_Chance
		H_reduced_Flask_Charges_used := ItemTypes.H_reduced_Flask_Charges_used
		H_increased_Flask_Charges_gained := ItemTypes.H_increased_Flask_Charges_gained
		H_increased_Flask_effect_duration := ItemTypes.H_increased_Flask_effect_duration
		H_Life_gained_on_Kill := ItemTypes.H_Life_gained_on_Kill
		H_Life_gained_for_each_Enemy_hit_by_your_Attacks := ItemTypes.H_Life_gained_for_each_Enemy_hit_by_your_Attacks
		H_Life_Regenerated_per_second := ItemTypes.H_Life_Regenerated_per_second
		H_Mana_Gained_on_Kill := ItemTypes.H_Mana_Gained_on_Kill
		H_increased_Mana_Regeneration_Rate := ItemTypes.H_increased_Mana_Regeneration_Rate
		H_increased_Projectile_Speed := ItemTypes.H_increased_Projectile_Speed
		H_reduced_Attribute_Requirements := ItemTypes.H_reduced_Attribute_Requirements
		H_to_all_Elemental_Resistances := ItemTypes.H_to_all_Elemental_Resistances
		H_to_Fire_Resistance := ItemTypes.H_to_Fire_Resistance
		H_to_Lightning_Resistance := ItemTypes.H_to_Lightning_Resistance
		H_to_Cold_Resistance := ItemTypes.H_to_Cold_Resistance
		H_to_Chaos_Resistance := ItemTypes.H_to_Chaos_Resistance
		H_to_Cold_Fire_Lightning_and_Cold_Fire_Lightning_Resistances := ItemTypes.H_to_Cold_Fire_Lightning_and_Cold_Fire_Lightning_Resistances
		H_Fire := ItemTypes.H_Fire
		H_Lightning := ItemTypes.H_Lightning
		H_Cold := ItemTypes.H_Cold
		H_increased_Stun_Duration_on_Enemies := ItemTypes.H_increased_Stun_Duration_on_Enemies
		H_reduced_Enemy_Stun_Threshold := ItemTypes.H_reduced_Enemy_Stun_Threshold
		
		H_Cold_Fire_Lightning := ".*" . H_to_Cold_Fire_Lightning_and_Cold_Fire_Lightning_Resistances
    ...
    Loop, Parse, ItemDataChunk, `n, `r
    {
        ...
        IfInString, A_LoopField, %H_increased_Attack_Speed%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_all_Attributes%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Strength%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Intelligence%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Dexterity%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Cast_Speed%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Critical_Strike_Chance_for_Spells%
        {
            NumSuffixes += 1
            ...
            Continue
				...
				If RegExMatch(A_LoopField, H_Critical_Strike_Chance_Sub)
        {
        ...
        IfInString, A_LoopField, %H_Critical_Strike_Multiplier%
        {
            If (ItemSubType == "Quiver" or ItemSubType == "Amulet")
            {
        ...
        IfInString, A_LoopField, %H_increased_Fire_Damage%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Cold_Damage%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Lightning_Damage%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_Block_Chance%
				{
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_reduced_Flask_Charges_used%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Flask_Charges_gained%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Flask_effect_duration%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_Life_gained_on_Kill%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_Life_gained_for_each_Enemy_hit_by_your_Attacks%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_Life_Regenerated_per_second%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_Mana_Gained_on_Kill%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Mana_Regeneration_Rate%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Projectile_Speed%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_reduced_Attribute_Requirements%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_all_Elemental_Resistances%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Fire_Resistance%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Lightning_Resistance%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Cold_Resistance%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_to_Chaos_Resistance%
        {
        ...
        If RegExMatch(A_LoopField, H_Cold_Fire_Lightning)
        {
            ...
            IfInString, A_LoopField, %H_Lightning%
            {
                NumSuffixes += 1
                ValueRange := LookupAffixData("data\LightningResist.txt", ItemLevel, CurrValue, "", CurrTier)
                AppendAffixInfo(MakeAffixDetailLine(A_LoopField, "Suffix", ValueRange, CurrTier), A_Index)
        ...
        IfInString, A_LoopField, %H_increased_Stun_Duration_on_Enemies%
        {
            NumSuffixes += 1
        ...
        IfInString, A_LoopField, %H_reduced_Enemy_Stun_Threshold%
        {
            NumSuffixes += 1
        ...
        ; Prefixes
				...
				H_to_Armour := ItemTypes.H_to_Armour
				H_to_Evasion_Rating := ItemTypes.H_to_Evasion_Rating
				H_to_maximum_Energy_Shield := ItemTypes.H_to_maximum_Energy_Shield
				H_increased_maximum_Energy_Shield := ItemTypes.H_increased_maximum_Energy_Shield
				H_Adds_Physical_Damage := ItemTypes.H_Adds_Physical_Damage
				H_Adds_Cold_Damage := ItemTypes.H_Adds_Cold_Damage
				H_Adds_Fire_Damage := ItemTypes.H_Adds_Fire_Damage
				H_Adds_Lightning_Damage := ItemTypes.H_Adds_Lightning_Damage
				H_Physical_Damage_to_Melee_Attackers := ItemTypes.H_Physical_Damage_to_Melee_Attackers
				H_to_Level_of_Socketed := ItemTypes.H_to_Level_of_Socketed
				H_maximum_Life := ItemTypes.H_maximum_Life
				H_Physical_Attack_Damage_Leeched_as := ItemTypes.H_Physical_Attack_Damage_Leeched_as
				H_Movement_Speed := ItemTypes.H_Movement_Speed
				H_increased_Elemental_Damage_with_Weapons := ItemTypes.H_increased_Elemental_Damage_with_Weapons
				H_increased_Flask_Mana_Recovery_rate := ItemTypes.H_increased_Flask_Mana_Recovery_rate
				H_increased_Flask_Life_Recovery_rate := ItemTypes.H_increased_Flask_Life_Recovery_rate

        IfInString, A_LoopField, %H_to_Armour%
        {
            NumPrefixes += 1
				...
				IfInString, A_LoopField, %H_increased_Armour_and_Evasion%
        {
            ...
            If (HasStunRecovery) 
            {
                ...
                BSRecBracketLevel := 0
                BSRecValue := ExtractValueFromAffixLine(ItemDataChunk, H_increased_Stun_Recovery)
        ...
        IfInString, A_LoopField, %H_to_Evasion_Rating%
        {
            NumPrefixes += 1
            If (ItemBaseType == "Item")
            {
        ...
        IfInString, A_LoopField, %H_to_maximum_Energy_Shield%
        {
            PrefixType := "Prefix"
        ...
        IfInString, A_LoopField, %H_increased_Energy_Shield%
        {
            ...
            Continue
				...
				IfInString, A_LoopField, %H_increased_maximum_Energy_Shield%
        {
            ...
            Continue
				...
				If RegExMatch(A_LoopField, H_Adds_Physical_Damage)
        {
        ...
        If RegExMatch(A_LoopField, H_Adds_Cold_Damage)
        {
        ...
        If RegExMatch(A_LoopField, H_Adds_Fire_Damage)
        {
            If (ItemSubType == "Amulet" or ItemSubType == "Ring")
            {
        ...
        If RegExMatch(A_LoopField, H_Adds_Lightning_Damage)
        {
            If (ItemSubType == "Amulet" or ItemSubType == "Ring")
            {
        ...
        IfInString, A_LoopField, %H_Physical_Damage_to_Melee_Attackers%
        {
            NumPrefixes += 1
        ...
        IfInString, A_LoopField, %H_to_Level_of_Socketed%
        {
            If (ItemBaseType == "Weapon")
            {
                If (ItemSubType == "Bow")
        ...
        IfInString, A_LoopField, %H_maximum_Life%
        {
            If (ItemSubType == "Amulet")
						{
        ...
        IfInString, A_LoopField, %H_Physical_Attack_Damage_Leeched_as%
        {
            NumPrefixes += 1
        ...
        IfInString, A_LoopField, %H_Movement_Speed%
        {
            NumPrefixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Elemental_Damage_with_Weapons%
        {
            NumPrefixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Flask_Mana_Recovery_rate%
        {
            NumPrefixes += 1
        ...
        IfInString, A_LoopField, %H_increased_Flask_Life_Recovery_rate%
        {
            NumPrefixes += 1
    ...
    ; --- COMPLEX AFFIXES ---
		...
		H_increased_Rarity := ItemTypes.H_increased_Rarity
    ...
    Loop, Parse, ItemDataChunk, `n, `r
    {
        ...
        IfInString, A_LoopField, %H_increased_Spell_Damage%
        {
            ...
            If (HasMaxMana)
            {
                SDBracketLevel := 0
                MMBracketLevel := 0
                MaxManaValue := ExtractValueFromAffixLine(ItemDataChunk, H_to_maximum_Mana)
        ...
        IfInString, A_LoopField, %H_increased_Physical_Damage%
        {
            ...
            If (HasToAccuracyRating)
            {
                ...
                ARValue := ExtractValueFromAffixLine(ItemDataChunk, H_to_Accuracy_Rating)
                ...
                {
                    LRValue := ExtractValueFromAffixLine(ItemDataChunk, H_increased_Light_Radius)
       ...
       SimpleIPDPrefix:
        ...
        IfInString, A_LoopField, %H_increased_Stun_Recovery%
        {
            ...
            If (HasHybridDefences)
            {
                ...
                If (Not IsValidBracket(BSRecAffixBracket))
                {
                    ...
                    {
                        PartialAffixString := H_increased_Armour_and_Evasion
                    }
                    If (HasIncrEvasionAndES) 
                    {
                        PartialAffixString := H_increased_Evasion_and_Energy_Shield
                    }
                    If (HasIncrArmourAndES)
                    {
                        PartialAffixString := H_increased_Armour_and_Energy_Shield
                    }
            ...
            Else
            {
                ...
                If (HasIncrArmour)
                {
                    PartialAffixString := H_increased_Armour
                    BSRecAffixPath := "data\StunRecovery_Armour.txt"
                }
                If (HasIncrEvasion) 
                {
                    PartialAffixString := H_increased_Evasion_Rating
                    BSRecAffixPath := "data\StunRecovery_Evasion.txt"
                }
                If (HasIncrEnergyShield)
                {
                    PartialAffixString := H_increased_Energy_Shield
        ...
        IfInString, A_LoopField, %H_to_Accuracy_Rating%
        {
            ...
            ValueRangeAR := "0-0"
            AffixType := ""
            IPDAffixType := GetAffixTypeFromProcessedLine(H_increased_Physical_Damage)
            If (HasIncrLightRadius and Not HasIncrAccuracyRating) 
            {
                ; "of Shining" and "of Light"
                LightRadiusValue := ExtractValueFromAffixLine(ItemDataChunk, H_increased_Light_Radius)
...
;                            AffixType := "Comp. Prefix+Comp. Suffix+Suffix"
        ...
        IfInString, A_LoopField, %H_increased_Rarity%
        {
            ActualValue := CurrValue
            If (NumSuffixes <= 3)
            {
    ...
    ; --- CRAFTED --- (Preliminary Support)
		...
		H_to_Weapon_range := ItemTypes.H_to_Weapon_range
    ...
    {    
        ...
        IfInString, A_LoopField, %H_to_Weapon_range%
        {
            AppendAffixInfo(A_Loopfield, A_Index)
        }
    }
...
AssembleDamageDetails(FullItemData)
{
    ...
    LighHi := 0
		...
		H_Quality := ItemTypes.H_Quality . ":"
		H_Physical_Damage := ItemTypes.H_Physical_Damage . ":"
		H_Elemental_Damage := ItemTypes.H_Elemental_Damage . ":"
		H_Attacks_per_Second := ItemTypes.H_Attacks_per_Second . ":"
		H_increased_Physical_Damage := ItemTypes.H_increased_Physical_Damage
		H_Converted_to := ItemTypes.H_Converted_to
		H_can_Shock := ItemTypes.H_can_Shock
		H_in_Off_Hand := ItemTypes.H_in_Off_Hand
		H_Type_Fire := ItemTypes.H_Type_Fire
		H_Type_Lightning := ItemTypes.H_Type_Lightning
		H_Type_Cold := ItemTypes.H_Type_Cold
		H_Type_Chaos := ItemTypes.H_Type_Chaos
    ...
    {        
        ...
        IfInString, A_LoopField, %H_Physical_Damage%
        {
            StringSplit, Arr, A_LoopField, %A_Space%
        ...
        IfInString, A_LoopField, %H_Elemental_Damage%
        {
            Continue
        }

        ; Get attack speed
        IfInString, A_LoopField, %H_Attacks_per_Second%
        {
            StringSplit, Arr, A_LoopField, %A_Space%
            AttackSpeed := Arr4
            Continue
        ...
        IfInString, A_LoopField, %H_Converted_to%
            Goto, SkipDamageParse
        IfInString, A_LoopField, %H_can_Shock%
            Goto, SkipDamageParse
        ...
        IfInString, A_LoopField, %H_in_Off_Hand%
            Goto, SkipDamageParse

        ; Parse elemental damage
        ParseElementalDamage(A_LoopField, H_Type_Chaos, ChaoLo, ChaoHi)
        ParseElementalDamage(A_LoopField, H_Type_Cold, ColdLo, ColdHi)
        ParseElementalDamage(A_LoopField, H_Type_Fire, FireLo, FireHi)
        ParseElementalDamage(A_LoopField, H_Type_Lightning, LighLo, LighHi)
...
ItemIsMirrored(ItemDataText)
{
		...
		H_Mirrored := ItemTypes.H_Mirrored
    Loop, Parse, ItemDataText, `n, `r
    {
        If (A_LoopField == H_Mirrored)
        {
            return True
        }
    }
...
{    
    Global Item, ItemData, AffixTotals, uniqueMapList, mapList, matchList, ItemTypes
    ...
    ItemData.FullText := ItemDataText
		...
		H_Corrupted := ItemTypes.H_Corrupted
    IfInString, ItemDataText, %H_Corrupted%
    {
    ...
    Item.TypeName := ItemTypeName
		...
		H_Unidentified := ItemTypes.H_Unidentified
    IfInString, ItemDataText, %H_Unidentified%
    {
